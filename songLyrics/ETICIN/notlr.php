...
<link rel="prefetch" href="../../images/notlr_INSTRUCTIONS.gif">
...
<style>
.cover {
    background-image: url('../../images/notlr_INSTRUCTIONS.gif');
}
.cover:hover {
...
And now, it's all
That you can <input type="button" onclick="background2()" value="see" style="color: #000;" /><img src="../../images/hp.gif" style="width:0px;height:0px;" alt="hp" />.
"It's coming for me!"
